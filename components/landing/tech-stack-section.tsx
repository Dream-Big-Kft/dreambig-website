...
const technologies = [
  {
    name: "React",
    icon: <Icon aria-hidden className={iconClassName} icon={reactIcon} />,
  },
  {
    name: "React Native",
    icon: <Icon aria-hidden className={iconClassName} icon={reactIcon} />,
  ...
  {
    name: "Next.js",
    icon: <Icon aria-hidden className={iconClassName} icon={nextIcon} />,
  },
  {
    name: "TanStack",
    icon: <TanstackIcon aria-hidden className={iconClassName} title="" />,
  },
  {
    name: "TypeScript",
    icon: <Icon aria-hidden className={iconClassName} icon={typescriptIcon} />,
  },
  {
    name: "Node.js",
    icon: <Icon aria-hidden className={iconClassName} icon={nodeIcon} />,
  },
  {
    name: "AWS",
    icon: <Icon aria-hidden className={awsIconClassName} icon={awsIcon} />,
  },
  {
    name: "GCP",
    icon: <Icon aria-hidden className={iconClassName} icon={gcpIcon} />,
  },
  {
    name: "PostgreSQL",
    icon: <Icon aria-hidden className={iconClassName} icon={postgresqlIcon} />,
  },
  {
    name: "DynamoDB",
    icon: <Icon aria-hidden className={iconClassName} icon={dynamodbIcon} />,
  },
  {
    name: "Figma",
    icon: <Icon aria-hidden className={iconClassName} icon={figmaIcon} />,
  },
  {
    name: "Claude",
    icon: (
  ...
  },
  {
    name: "ChatGPT",
    icon: (
      <Icon aria-hidden className={darkInvertIconClassName} icon={openaiIcon} />
    ),
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-7">
          {technologies.map((technology) => (
            <div key={technology.name} className={technologyCardClassName}>
              {technology.icon}
